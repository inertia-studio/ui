    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-s-bg px-4">
            <div className="w-full max-w-md">
                ...
                {/* Theme toggle — switch without text */}
                <div className="flex items-center justify-center mt-6">
                    ...
                    >
                        <div
                            className="absolute top-[3px] w-4 h-4 rounded-full bg-white shadow-sm transition-transform flex items-center justify-center"
                            style={{ transform: darkMode ? 'translateX(22px)' : 'translateX(3px)' }}
                        >
                            {darkMode ? (
                                <svg className="w-2.5 h-2.5" style={{ color: 'rgb(var(--s-accent))' }} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" />
                                </svg>
                            ) : (
                                <svg className="w-2.5 h-2.5 text-amber-500" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
