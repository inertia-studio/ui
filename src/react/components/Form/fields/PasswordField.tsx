...
export function PasswordField({ schema, value, onChange, error }: PasswordFieldProps) {
        ...
        <div className="relative">
            ...
            {schema.revealable && (
                <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center pr-3 text-s-text-faint hover:text-s-text-muted"
