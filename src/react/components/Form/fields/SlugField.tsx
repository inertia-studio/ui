...
export function SlugField({ schema, value, onChange, error }: SlugFieldProps) {
    return (
        <div>
            <div className="flex">
                {schema.prefix && (
            ...
            <p className="mt-1 text-xs text-s-text-faint">
                Auto-generated from <span className="font-medium">{schema.from}</span>
            </p>
        </div>
    );
}
