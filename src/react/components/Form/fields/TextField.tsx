...
export function TextField({ schema, value, onChange, error }: TextFieldProps) {
    const showCounter = schema.maxLength !== null;
    ...
    return (
        <div className="relative">
            ...
            {showCounter && (
                <span className="absolute bottom-1 right-2 text-xs text-s-text-faint">
